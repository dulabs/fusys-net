...
gulp.task('copy-modules', ['clean-module'], function () {
  ...
  gulp.src(paths.devModules + 'Fu.Module.SampleData/SampleContent/**/*.*')
          .pipe(gulp.dest(paths.hostModules + 'Fu.Module.SampleData/SampleContent'));
});
...
function loadModules() {
  ...
  moduleManifestPaths = glob.sync(paths.devModules + 'Fu.Module.*/module.json', {});
